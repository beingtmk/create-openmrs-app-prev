...
export const FORM_ANSWERS = {
  clinicalOutcome: [
    {
      uuid: CONCEPTS.Clinical.FollowUp.uuid,
      display: CONCEPTS.Clinical.FollowUp.display,
    },
    {
    ...
    {
      uuid: CONCEPTS.Clinical.ExitFromCare.uuid,
      display: CONCEPTS.Clinical.ExitFromCare.display,
    },
    {
      uuid: CONCEPTS.Clinical.Other.uuid,
      display: CONCEPTS.Clinical.Other.display,
    },
  ],
  clinicalFollowUp: [
    {
      uuid: CONCEPTS.Clinical.NextAppointmentDate.uuid,
      display: CONCEPTS.Clinical.NextAppointmentDate.display,
    },
    {
      uuid: CONCEPTS.Clinical.QualitativeTime.uuid,
      display: CONCEPTS.Clinical.QualitativeTime.display,
    },
  ],
  clinicalQualitativeTime: [
    {
      uuid: CONCEPTS.Clinical.QualitativeTimeAM.uuid,
      display: CONCEPTS.Clinical.QualitativeTimeAM.display,
    },
    {
      uuid: CONCEPTS.Clinical.QualitativeTimePM.uuid,
      display: CONCEPTS.Clinical.QualitativeTimePM.display,
    },
  ],
  tbTestTypeanswers: [
  ...
  GeneXpertAnswers: [
    ...
    {
      uuid: CONCEPTS.TBUndetected.uuid,
      display: CONCEPTS.TBUndetected.display,
    },
    {
      uuid: CONCEPTS.ReasonForNoResult.uuid,
      display: CONCEPTS.ReasonForNoResult.display,
    },
  ],
  SmearAnswers: [
    {
      uuid: CONCEPTS.TBSmearResult.Positive.uuid,
      display: CONCEPTS.TBSmearResult.Positive.display,
    },
    {
      uuid: CONCEPTS.TBSmearResult.Negative.uuid,
      display: CONCEPTS.TBSmearResult.Negative.display,
    },
    {
      uuid: CONCEPTS.TBSmearResult.NoResult.uuid,
      display: CONCEPTS.TBSmearResult.NoResult.display,
    },
  ],
  RifampinResistanceAnswers: [
    {
      uuid: CONCEPTS.PositiveRifampinResistance.uuid,
      display: CONCEPTS.PositiveRifampinResistance.display,
    },
    {
      uuid: CONCEPTS.NegativeRifampinResistance.uuid,
      display: CONCEPTS.NegativeRifampinResistance.display,
    },
    {
      uuid: CONCEPTS.IndeterminateRifampinResistance.uuid,
      display: CONCEPTS.IndeterminateRifampinResistance.display,
    },
  ],
  ReasonForNoTBResultAnswers: [
    {
      uuid: CONCEPTS.Contaminated.uuid,
      display: CONCEPTS.Contaminated.display,
    },
    {
      uuid: CONCEPTS.UnsatisfactorySample.uuid,
      display: CONCEPTS.UnsatisfactorySample.display,
    },
    {
      uuid: CONCEPTS.EquipmentFailure.uuid,
      display: CONCEPTS.EquipmentFailure.display,
    },
    {
      uuid: CONCEPTS.InappropriateSampleContainer.uuid,
      display: CONCEPTS.InappropriateSampleContainer.display,
    },
    {
      uuid: CONCEPTS.UnavailableSupplies.uuid,
      display: CONCEPTS.UnavailableSupplies.display,
    },
    { uuid: CONCEPTS.Other.uuid, display: CONCEPTS.Other.display },
  ],
  referrals: [
    {
      uuid: CONCEPTS.SOURCE_OF_REFERRAL.SHARC.uuid,
      display: CONCEPTS.SOURCE_OF_REFERRAL.SHARC.display,
    },
    {
    ...
    {
      uuid: CONCEPTS.SOURCE_OF_REFERRAL.Inpatient.uuid,
      display: CONCEPTS.SOURCE_OF_REFERRAL.Inpatient.display,
    },
    {
    ...
    {
      uuid: CONCEPTS.SOURCE_OF_REFERRAL.Other.uuid,
      display: CONCEPTS.SOURCE_OF_REFERRAL.Other.display,
    },
  ],
  sampleQualityAnswers: [
    {
      uuid: CONCEPTS.satisfactorySampleQuality.uuid,
      display: CONCEPTS.satisfactorySampleQuality.display,
    },
    {
      uuid: CONCEPTS.unsatisfactorySampleQuality.uuid,
      display: CONCEPTS.unsatisfactorySampleQuality.display,
    },
  ],
  trueFalse: [
  ...
  eidNoSampleAnswers: [
    {
      uuid: CONCEPTS.UnableToDrawBlood.uuid,
      display: CONCEPTS.UnableToDrawBlood.display,
    },
    {
      uuid: CONCEPTS.PatientRefused.uuid,
      display: CONCEPTS.PatientRefused.display,
    },
    {
      uuid: CONCEPTS.InadequateSupplies.uuid,
      display: CONCEPTS.InadequateSupplies.display,
    },
  ],
  noSampleAnswers: [
    {
    ...
    {
      uuid: CONCEPTS.NeedsAdherenceCounseling.uuid,
      display: CONCEPTS.NeedsAdherenceCounseling.display,
    },
  ],
  reasonForTesting: [
    { uuid: CONCEPTS.Routine.uuid, display: CONCEPTS.Routine.display },
    {
      uuid: CONCEPTS.Confirmatory.uuid,
      display: CONCEPTS.Confirmatory.display,
    },
    { uuid: CONCEPTS.Target.uuid, display: CONCEPTS.Target.display },
  ],
  eidHivTestType: [
    {
      uuid: CONCEPTS.HIV_RAPID_TEST.uuid,
      display: CONCEPTS.HIV_RAPID_TEST.display,
    },
    {
      uuid: CONCEPTS.HIV_DNA_PCR_TEST.uuid,
      display: CONCEPTS.HIV_DNA_PCR_TEST.display,
    },
  ],
  dnaPcrReasonForTesting: [
    {
      uuid: CONCEPTS.SixWeeksRoutine.uuid,
      display: CONCEPTS.SixWeeksRoutine.display,
    },
    {
      uuid: CONCEPTS.Confirmatory.uuid,
      display: CONCEPTS.Confirmatory.display,
  ...
  dnaPcrTestResults: [
    {
      uuid: CONCEPTS.DNA_PCR_TEST_RESULT_POSITIVE.uuid,
      display: CONCEPTS.DNA_PCR_TEST_RESULT_POSITIVE.display,
    },
    {
      uuid: CONCEPTS.DNA_PCR_TEST_RESULT_NEGATIVE.uuid,
      display: CONCEPTS.DNA_PCR_TEST_RESULT_NEGATIVE.display,
    },
    {
      uuid: CONCEPTS.DNA_PCR_TEST_RESULT_NO_RESULT.uuid,
      display: CONCEPTS.DNA_PCR_TEST_RESULT_NO_RESULT.display,
    },
  ],
  ...
  labLocation: [
    {
      uuid: CONCEPTS.NenoGeneXpert.uuid,
      display: CONCEPTS.NenoGeneXpert.display,
    },
    {
      uuid: CONCEPTS.CentralLaboratory.uuid,
      display: CONCEPTS.CentralLaboratory.display,
    },
    {
      uuid: CONCEPTS.LisungwiGeneXpert.uuid,
      display: CONCEPTS.LisungwiGeneXpert.display,
    },
  ],
  sputumLabLocation: [
    {
  ...
  hivTestResultAnswers: [
    {
      uuid: CONCEPTS.HIV_TEST_RESULTS.Reactive.uuid,
      display: CONCEPTS.HIV_TEST_RESULTS.Reactive.display,
    },
    {
      uuid: CONCEPTS.HIV_TEST_RESULTS.Non_Reactive.uuid,
      display: CONCEPTS.HIV_TEST_RESULTS.Non_Reactive.display,
    },
    {
      uuid: CONCEPTS.HIV_TEST_RESULTS.Not_Done.uuid,
      display: CONCEPTS.HIV_TEST_RESULTS.Not_Done.display,
    },
  ],
  adherenceSession: [
    {
      ...
      display:
        CONCEPTS.ADHERENCE_COUNSELING.AdherenceSession.FirstSession.display,
    },
    {
      uuid: CONCEPTS.ADHERENCE_COUNSELING.AdherenceSession.SecondSession.uuid,
      display:
        CONCEPTS.ADHERENCE_COUNSELING.AdherenceSession.SecondSession.display,
    },
    {
      uuid: CONCEPTS.ADHERENCE_COUNSELING.AdherenceSession.ThirdSession.uuid,
      display:
        CONCEPTS.ADHERENCE_COUNSELING.AdherenceSession.ThirdSession.display,
    },
  ],
  coughPresent: [{ uuid: CONCEPTS.TB.Cough.uuid, display: 'Yes' }],
  coughAbsent: [{ uuid: CONCEPTS.TB.Cough.uuid, display: 'No' }],
  feverPresent: [{ uuid: CONCEPTS.TB.Fever.uuid, display: 'Yes' }],
  feverAbsent: [{ uuid: CONCEPTS.TB.Fever.uuid, display: 'No' }],
  nightSweatPresent: [{ uuid: CONCEPTS.TB.NightSweats.uuid, display: 'Yes' }],
  nightSweatAbsent: [{ uuid: CONCEPTS.TB.NightSweats.uuid, display: 'No' }],
  weightLossPresent: [{ uuid: CONCEPTS.TB.WeightLoss.uuid, display: 'Yes' }],
  weightlossAbsent: [{ uuid: CONCEPTS.TB.WeightLoss.uuid, display: 'No' }],
  ...
  breastfeedingAnswers: [
    {
      uuid: CONCEPTS.ExclusiveBreastfeeding.uuid,
      display: CONCEPTS.ExclusiveBreastfeeding.display,
    },
    {
      uuid: CONCEPTS.MixedFeeding.uuid,
      display: CONCEPTS.MixedFeeding.display,
    },
    {
      uuid: CONCEPTS.ComplimentaryBreastfeeding.uuid,
      display: CONCEPTS.ComplimentaryBreastfeeding.display,
    },
    {
      uuid: CONCEPTS.StoppedBreastfeeding.InLastSixWeeks.uuid,
      display: CONCEPTS.StoppedBreastfeeding.InLastSixWeeks.display,
    },
    {
      uuid: CONCEPTS.StoppedBreastfeeding.OverSixWeeks.uuid,
      display: CONCEPTS.StoppedBreastfeeding.OverSixWeeks.display,
    },
  ],
};
...
export const EID_ALERTS = [...EID_RAPID_TEST, ...EID_DNA_PCR];
